...
- [Node usage](https://github.com/availproject/avail-js/tree/main/examples/node-examples)
- [Web usage](https://github.com/availproject/avail-js/tree/main/examples/next-example)
