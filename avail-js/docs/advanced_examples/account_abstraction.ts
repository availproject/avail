import { SDK, Keyring, BN, Weight, TxResultDetails, MultisigTimepoint, Account, WaitFor } from "./../../src/index"
...
const main = async () => {
  ...
  /*
    Sometimes the existing sdk functions can see too low level and cumbersome to use.
  ...
  */
  account.setAppId(parseInt(r2._unsafeUnwrap().event.id))
