...
const main = async () => {
  ...
  // Converting hex string to H256 (BlockHash) via SDK safe
  const hexString = "0x4a78c9fd1d88c99fc217eec0ac405307092e53523f6db19fae0242a5af9f4fe3"
  const hex1 = sdk.util.hexStringToHash(hexString)
  if (hex1.isErr()) throw Error(hex1.error)
  console.log(hex1.value.toHex()) // `0x4a78c9fd1d88c99fc217eec0ac405307092e53523f6db19fae0242a5af9f4fe3`

  // Converting hex string to H256 (BlockHash) via SDK unsafe
  ...
  const hex3 = sdkUtil.hexStringToHash(api, hexString)
  ...
  const hex4 = sdkUtil.hexStringToHashUnsafe(api, hexString)
  ...
  const f1 = sdk.util.hexStringToHash(hexString2)
  ...
  const f2 = sdk.util.hexStringToHash(hexString3)
