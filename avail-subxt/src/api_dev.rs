	...
	pub mod nomad_home {
		...
		pub mod calls {
			...
			impl TransactionApi {
				...
				#[doc = "Set new updater on self as well as updater manager."]
				#[doc = "Note: Not exposed as pallet call, will only be callable by the"]
				#[doc = "GovernanceRouter pallet when implemented."]
				pub fn set_updater(
					&self,
