/// The example showcases how to programmatically call query app data RPC. 
///
...
const appData = await api.rpc.kate.queryAppData(0, block_hash);
console.log(appData.toHuman());
