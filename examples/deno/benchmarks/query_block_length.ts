...
console.log("Querying Block Length...")
performance.mark("start");
const _ = await api.rpc.kate.blockLength(targetBlockHash);
performance.mark("end");
console.log(performance.measure('Querying Block Length', 'start', 'end'))
