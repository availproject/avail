...
console.log("Querying Data Proof...")
performance.mark("start");
const _ = await api.rpc.kate.queryDataProof(1, targetBlockHash);
performance.mark("end");
console.log(performance.measure('Querying Data Proof', 'start', 'end'))
