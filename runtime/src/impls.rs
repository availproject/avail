...
use avail_core::{
	currency::{Balance, AVAIL, CENTS, PICO_AVAIL},
	AppId,
};
...
parameter_types! {
	...
	pub const TransactionByteFee: Balance = 0; // Temp
...
parameter_types! {
	...
	pub RuntimeBlockLength: BlockLength =
		BlockLength::max_with_normal_ratio(1024 * 1024 * 1024, constants::system::NORMAL_DISPATCH_RATIO_PERBILL);
}
