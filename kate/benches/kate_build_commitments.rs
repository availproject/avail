...
use kate::{
	com::{
		build_commitments, extend_data_matrix, flatten_and_pad_block, opt_par_build_commitments,
		par_build_commitments, par_extend_data_matrix,
	},
...
criterion_group! {name = kate_build_commitments; config = Criterion::default().sample_size(10); targets = bench_extend_data_matrix, bench_par_extend_data_matrix, bench_build_commitments, bench_par_build_commitments, bench_opt_par_build_commitments}
