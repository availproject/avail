...
use crate::native::hosted_header_builder::da::BlockNumber;
...
pub type MockDaBlock<T> = sp_runtime::generic::Block<
	avail_core::header::runtime::Header<BlockNumber, sp_runtime::traits::BlakeTwo256>,
	MockUncheckedExtrinsic<T>,
>;
