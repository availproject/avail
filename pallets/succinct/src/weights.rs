...
//! HOSTNAME: `sasas-mbp`, CPU: `<UNKNOWN>`
...
// --log=warn
// --output
// ./pallets/succinct/src/weights.rs
...
impl<T: frame_system::Config> pallet_succinct::WeightInfo for WeightInfo<T> {
	...
	fn send_message_arbitrary_message(l: u32, ) -> Weight {
		...
		Weight::from_parts(9_501_524, 0)
			.saturating_add(Weight::from_parts(0, 41487))
			// Standard Error: 0
			.saturating_add(Weight::from_parts(200, 0).saturating_mul(l.into()))
	...
	fn fulfill_call() -> Weight {
		...
		//  Measured:  `235`
		//  Estimated: `3505`
		// Minimum execution time: 7_399_000_000 picoseconds.
		Weight::from_parts(7_561_000_000, 0)
	...
	fn execute_arbitrary_message(l: u32, ) -> Weight {
		...
		Weight::from_parts(53_888_236, 0)
			.saturating_add(Weight::from_parts(0, 41487))
			// Standard Error: 2
